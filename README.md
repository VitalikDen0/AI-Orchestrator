...
- Векторное хранилище, оно реализовано, но по-моему работает пока не так, как нужно. ~~Будет дорабатываться, но это пока на задний план~~ Выкатил фикс, должно работать. Upd, провел тесты, теперь работает 100%
