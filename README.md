...
- Голос ИИ, говорит только самое важное, остальное пишет текстом. Работает, сделал универсально, с другими голосами **maybe** позже
- Векторное хранилище, оно реализовано, но по-моему работает пока не так, как нужно. ~~Будет дорабатываться, но это пока на задний план~~ Выкатил фикс, должно работать

## 🗺️ Планы развития (чем выше, тем больше приоритет)

- [ ] **PDF обработка**: Чтобы считывать PDF (возможно их создание)
- [ ] **Работа с docx, excel**: Попробвать анализировать содержимое файлов, возможно генерировать (скорее всего не будем генерировать, только через .md)
