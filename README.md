...
- Windows UI Automation API - Пока не понимаю как это реализовать, перепробовал много методов, возможно я что-то упускаю. Параллельно есть мысли об интеграции с BrowserOS, мне не нужно будет создавать **Управление браузером**, я буду использовать уже готовое. Возможно я передумаю, но создавать нечто такое с нуля будет для меня неподъемной задачей. Скоро будет пару обновлений
