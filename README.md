...
- На данный момент идет разработка аудита всех действий
...
- Реализовал Google Colab, но я скорее всего вы не сможете скачать модель без авторизации на hugging face. Можете посмотреть как все там работает, я дал почву, вы веселитесь, может я допишу плагин, но пока не хочу
